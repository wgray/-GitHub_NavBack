...
\usepackage[absolute,overlay]{textpos} %% this is the package for \textblock 
...
\begin{frame}
	\titlepage
  		...
  		{\includegraphics[scale=.3]{/Users/GrayMatter/Library/texmf/tex/zLogoFigs/CEU_logo}}
    	   \end{textblock} 
...
\begin{frame}
	...
	\begin{itemize}
			\item \fullcite{ralph12csc.paper}
	\end{itemize}
\end{frame}
...
\subsection{Orientation: Applied Problems as a Driver of Basic Research}
 ...
 Understanding and predicting cognitive workload is an important applied problem the solution of which requires development of basic theory in \emph{control of cognition}
	...
	\begin{textblock}{9}(1,12)
		\begin{alertblock}{}
			\tiny{\fullcitebib{lewin51book,newellcard85}}
		\end{alertblock}
	\end{textblock}
...
\begin{frame}
	...
	\begin{columns}
	\column{0.3\textwidth}
		\includegraphics[width=\textwidth]{/Users/GrayMatter/Library/texmf/tex/zFigs/Pasteurs-Quadrant-Stokes}
	\column{0.7\textwidth}
		\includegraphics[width=\textwidth]{/Users/GrayMatter/Library/texmf/tex/zFigs/Pasteur}
	\end{columns}
...
\begin{frame}
	...
	\frametitle{CONTROL OF COGNITION}
		...
		\listpart{In addition, cognitive control is itself a resource that is limited and a complete theory of cognitive workload must consider:}
